  ...
  return (
    <div className="p-4 max-w-2xl space-y-4">
      ...
      <form onSubmit={submit} className="space-y-3">
        ...
        <div className="flex items-center gap-2"><button disabled={busy} className="rounded-xl px-4 py-2 border">{busy ? 'Guardando…' : 'Guardar cambios'}</button><DeleteProductButton id={id} /></div>
