...
function ProductsTable({ products, categories }: { products: Product[]; categories: Category[] }) {
...
/** Quick status filter helper (client-side) */
// If you prefer server-side filtering, wire this to search params in page.tsx.
